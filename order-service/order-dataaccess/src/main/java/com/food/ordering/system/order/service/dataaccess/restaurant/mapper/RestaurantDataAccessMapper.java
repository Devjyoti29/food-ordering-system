...
public class RestaurantDataAccessMapper {
    ...
    public List<UUID> restaurantToRestaurantProducts(Restudent restaurant) {
        return restaurant.getProducts().stream()
                .map(product -> product.getId().getValue())
                .collect(Collectors.toList());
    }

    public Restudent restaurantEntityToRestaurant(List<RestaurantEntity> restaurantEntities) {
        ...
        return Restudent.builder()
                .id(new RestudentId(restaurantEntity.getRestaurantId()))
