...
public class OrderMessagingDataMapper {
    ...
    orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setSagaId("")
                .setOrderId(order.getId().getValue().toString())
                .setRestaurantId(order.getRestudentId().getValue().toString())
                .setOrderId(order.getId().getValue().toString())
    ...
    public ResturantApprovalResponse
    approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel
                                                        restaurantApprovalResponseAvroModel) {
        return ResturantApprovalResponse.builder()
                .id(restaurantApprovalResponseAvroModel.getId())
                .sagaId(restaurantApprovalResponseAvroModel.getSagaId())
                .resturantId(restaurantApprovalResponseAvroModel.getRestaurantId())
