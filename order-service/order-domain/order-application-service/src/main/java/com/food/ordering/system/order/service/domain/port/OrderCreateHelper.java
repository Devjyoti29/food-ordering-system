package com.food.ordering.system.order.service.domain.port;
...
public class OrderCreateHelper {
    ...
    public OrderCreatedEvent persistOrder(CreateOrderCommand createOrderCommand){
        ...
        Restudent restudent=checkRestaurant(createOrderCommand);
        Order order=orderDataMapper.createOrderCommandToOrder(createOrderCommand);

        OrderCreatedEvent orderCreatedEvent= orderDomainService.validateAndInitializeOrder(order,restudent);
        saveOrder(order);
    ...
    private Restudent checkRestaurant(CreateOrderCommand createOrderCommand) {

        Restudent restudent=orderDataMapper.createOrderCommandToResturant(createOrderCommand);
