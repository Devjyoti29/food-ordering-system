...
public class OrderApplicationServiceTest {
    ...
    public void init(){
        createOrderCommand = CreateOrderCommand.builder()
                ...
                .address(OrderAddress.builder()
                        ...
                        .build())
                .price(PRICE)
                .item(List.of(OrderItem.builder()
        ...
        Restudent restaurantResponse = Restudent.builder()
    ...
    public void testCreateOrderWithWrongTotalPrice(){
        ...
        assertEquals(
                "Total price 250.00 not equal to Order item price total: 200.00!"
